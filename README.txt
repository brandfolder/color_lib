= ColorLib
ColorLib is a Ruby library to provide basic RGB, CMYK, HSL, and other colourspace
...
The capabilities of the ColorLib library are limited to pure mathematical
...
L*a*b*) are not supported because ColorLib does not yet support colour profiles,
...
ColorLib version 1.4 is the result of a project merge between color.rb 0.1.0 by
Matt Lyon and color-tools 1.3 by Austin Ziegler. Please see History.txt for
details on the changes this merge brings. ColorLib version 1.4.1 changes
